<template>
  <div class="navbar-container col-md-9 col-xl-10 px-0">
    <el-menu
      ...
      class="row"
    >
      <el-menu-item index="1" class="d-md-none bg-color-primary col-2 col-sm-1 col-md-0 px-0">
        <div class="menu-mobile">
          <div class="menu" @click="changeValue">
            <font-awesome-icon :icon="['fas', 'bars']" class="nav-icon text-white" v-if="!isCollapse"/>
            <font-awesome-icon :icon="['fas', 'times']" class="nav-icon text-white" v-else/>
          </div>
        </div>
        <MobileSiderbar/>
      </el-menu-item>
      <div class="col-10 col-sm-11 col-md-12 col-xl-12 d-flex justify-content-end pr-0">
        <el-submenu index="2">
          <template slot="title">
            <img
              v-if="hasProfileImg()"
          ...
          <el-menu-item index="2-2">
              <router-link
                class="my-2 btn btn-block text-left"
                to="/changepassword"
              ><li class="ml-auto mt-1 text-muted">
                Change password
              </li>
              </router-link>
          </el-menu-item>
          ...
          <el-menu-item index="2-3" @click="logout">
            <li class="ml-auto mb-1">
              <a class="my-2 btn btn-block text-left">
                Logout
              </a>
            </li>
          </el-menu-item>
        </el-submenu>
        <el-menu-item index="1" class="d-md-none bg-color-primary col-2 col-sm-1 px-0">
          <div class="menu-mobile">
            <img
