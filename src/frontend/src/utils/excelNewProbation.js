...
export async function generateNewProbationForm(data){
  ...
  const worksheet = workbook.addWorksheet('New Probation');
  ...
  worksheet.getCell('B1').value = {
    'richText': [
      {'font': ExcelStyles.headerTitle, 'text': data.templateTitle}
    ]
  };
  //Employee Name
  ...
  worksheet.getCell('B2').value = {
    'richText': [
      {'font': ExcelStyles.labelFont, 'text': 'Employee name:'}
    ]
  };
  worksheet.getCell('G2').value = data.newProbation.employeeName;
  //Job Title
  worksheet.mergeCells('B3:F3');
  worksheet.getCell('B3').value = {
    'richText': [
      {'font': ExcelStyles.labelFont, 'text': 'Job title:'}
    ]
  };
  worksheet.getCell('G3').value = data.newProbation.jobTitle === "Not Found" ? "......" : data.newProbation.jobTitle;
  //Line Manager
  worksheet.mergeCells('B4:F4');
  worksheet.getCell('B4').value = {
    'richText': [
      {'font': ExcelStyles.labelFont, 'text': 'Line manager:'}
    ]
  };
  worksheet.getCell('G4').value = data.newProbation.probationLineManagerName === null ? "......" : data.newProbation.probationLineManagerName;
  //Period of Appraisal
  worksheet.mergeCells('B5:F5');
  worksheet.getCell('B5').value = {
    'richText': [
      {'font': ExcelStyles.labelFont, 'text': 'Period of appraisal:'}
    ]
  };
  worksheet.getCell('G5').value = "From " + data.newProbation.startDay + " to " + data.newProbation.endDay;
  ...
  competenciesHeaderCell.value = {
    'richText': [
      {'font': ExcelStyles.whiteHeaderFont, 'text': 'Competencies'}
    ]
  };
  ...
  data.competenceAssessorRoles.forEach(role => {
    ...
    worksheet.getCell(titleStartCell).value = {
      'richText': [
        {'font': ExcelStyles.headerFont, 'text': role}
      ]
    };
    worksheet.getCell(titleStartCell).alignment = {vertical: 'middle', horizontal: 'center'};
    ...
    worksheet.getCell(scoringStartCell).value = {
      'richText': [
        {'font': ExcelStyles.headerFont, 'text': 'Scoring'}
      ]
    };
    worksheet.getCell(scoringStartCell).alignment = {vertical: 'middle', horizontal: 'center'};
    ...
    for(let i=0; i<5; i++) {
      ...
      worksheet.getCell(scoreCell).value = {
        'richText': [
          {'font': ExcelStyles.headerFont, 'text': i+1}
        ]
      };
      worksheet.getCell(scoreCell).alignment = {vertical: 'middle', horizontal: 'center'};
    ...
    worksheet.getCell(detailCell).value = {
      'richText': [
        {'font': ExcelStyles.headerFont, 'text': 'Comments'}
      ]
    };
    worksheet.getCell(detailCell).alignment = {vertical: 'middle', horizontal: 'center'};
  ...
  data.competenceData.forEach(competency => {
    ...
    worksheet.getCell(competencyNameCell).value = competency.competence;
    let evaluationStartCol = temp_col;
    data.competenceAssessorRoles.forEach(role => {
      let evaluation = competency.assessor_roles[role]
      if(evaluation) {
  ...
  commentNameHeaderCell.alignment = {vertical: 'middle', horizontal: 'center'};
  ...
  worksheet.getCell(commentDetailHeaderCell).value = {
    'richText': [
      {'font': ExcelStyles.headerFont, 'text': 'Detailed comments'}
    ]
  };
  worksheet.getCell(commentDetailHeaderCell).alignment = {vertical: 'middle', horizontal: 'center'};
  ...
  worksheet.getCell(assessorStartCell).value = {
    'richText': [
      {'font': ExcelStyles.headerFont, 'text': 'Assessor'}
    ]
  };
  worksheet.getCell(assessorStartCell).alignment = {vertical: 'middle', horizontal: 'center'};
  ...
  worksheet.getCell(roleHeaderCell).alignment = {vertical: 'middle', horizontal: 'center'};
  ...
  data.overCmtData.forEach(evaluation => {
    ...
    worksheet.getCell(commentNameCellName).value = evaluation.overall_comment.term;
    //Score
    const score = evaluation.score > 0? evaluation.score : 1;
    ...
    assessorCell.value = evaluation.assessor === null ? "......." : evaluation.assessor_name;
    //Assessor Role
    let assessorRoleCellName = getCellName(temp_col + 12, temp_row);
    worksheet.getCell(assessorRoleCellName).value = evaluation.overall_comment_role;
    temp_row++;
  });
  ...
  cell.value = {
    'richText': [
      {'font': ExcelStyles.bodyFont, 'text': 'Yes'}
    ]
  };
  ...
  cell.value = {
    'richText': [
      {'font': ExcelStyles.bodyFont, 'text': 'No'}
    ]
  };
  //Labor contract term:
  temp_row ++;
  ...
  cell.value = {
    'richText': [
      {'font': ExcelStyles.bodyFont, 'text': 'Labor contract term:'}
    ]
  };
  ...
  worksheet.getCell(startCellName).value = {
    'richText': [
      {'font': ExcelStyles.bodyFont, 'text': data.newProbation.term}
    ]
  };
  ...
  worksheet.getCell(startCellName).value = {
    'richText': [
      {'font': ExcelStyles.bodyFont, 'text': data.newProbation.otherUpdateAction}
    ]
  };
  //Director’s approval:
  temp_row ++;
  ...
  cell.value = {
    'richText': [
      {'font': ExcelStyles.bodyFont, 'text': "Director’s approval:"}
    ]
  };
  if(data.newProbation.approved) {
    cellName = getCellName(temp_col + 1, temp_row);
    cell = worksheet.getCell(cellName);
    cell.value = CHECK_SYMBOL_UNICODE;
    cell.alignment = ExcelStyles.centerAlignment;
  ...
  cell.value = {
    'richText': [
      {'font': ExcelStyles.bodyFont, 'text': 'Approve'}
    ]
  };
  cellName = getCellName(temp_col + 4, temp_row);
  cell = worksheet.getCell(cellName);
  cell.value = {
    'richText': [
      {'font': ExcelStyles.bodyFont, 'text': 'Disapprove'}
    ]
  };

  let fileName = 'newProbation.xlsx';
  if(data.newProbation.employeeName !== null){
    fileName = data.newProbation.employeeName
  }
