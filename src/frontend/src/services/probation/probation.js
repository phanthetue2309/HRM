...
class ProbationService extends BaseService {
    ...
    async createEvaluationTemplate(data) {
        try {
            return await this.request().post(`${this.entity}/evaluation_template`, data)
        } catch (e) {
            return e.response
        }
    }
    ...
    async updateEvaluationTemplate(data) {
        try {
            return await this.request().put(`${this.entity}/evaluation_template/${data['id']}`, data)
        } catch (e) {
            return e.response
        }
    }
    ...
    async deleteEvaluationTemplate(id) {
        try {
            return await this.request().delete(`/${this.entity}/evaluation_template/${id}`);
        } catch (e) {
            return e.response
        }
    }
