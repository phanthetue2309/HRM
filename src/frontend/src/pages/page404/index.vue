      ...
      <div class="container">
        <div class="row">
            ...
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              ...
              <g>
                ...
                <g ref="planet">
                  ...
                  <circle ref="craterBig" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="548.891"
                    cy="62.319" r="13.074" />

                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="591.743"
                    cy="158.918" r="7.989" />
          ...
          c0-3.378-15.347-4.988-40.243-7.225" />
                  ...
                  <path opacity="0.5" fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                    stroke-miterlimit="10" d="
          M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149" />
                ...
                <g ref="spaceman" clip-path="url(cordClip)">
                  <path fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
          ...
          C360.647,451.083,349.251,457.661,338.164,454.689z" />
            ...
            M269.678,394.912L269.678,394.912c26.3,20.643,59.654,29.585,93.106,25.724l2.419-0.114" />
              ...
              C278.993,441.286,286.836,447.55,296.315,452.273z" />
                  ...
                  <g>
                    ...
                    <path ref="headStripe" fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                      stroke-linejoin="round" stroke-miterlimit="10" d="
            ...
            s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z" />
                    <g clip-path="url(#GlassClip)">
                      <polygon ref="glassShine" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" points="
          ...
          <div class="col-md-6 align-self-center">
            ...
            <p>The page you are looking for does not exist.
              How you got here is a mystery. But you can click the buttons below
              to go to the homepage or go back to previous page.
            </p>
            <div class="btn-container">
              <button class="btn green" @click="$router.push('/')">HOME</button>
              <button class="btn blue" @click="$router.go(-1)">BACK</button>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    addAnimation() {
      ...
      gsap.to(this.$refs.circlesSmall, {
        y: -4,
        yoyo: true,
        duration: 1,
        ease: "sine.inOut",
      ...
      gsap.set(this.$refs.glassShine, { x: -68 });
      gsap.to(this.$refs.glassShine, {
        x: 80,
        duration: 2,
        rotation: -30,
        ease: "expo.inOut",
