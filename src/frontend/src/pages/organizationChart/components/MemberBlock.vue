<template>
  <div class="org-container" :ref="`org-container-${orgData.type}-${orgData.id}`">
    <div class="content-container">
      ...
      >
        <div class="name-block">
          <div class="member-block" v-for="children in orgData.children" :key="children.member_id">
            <div class="avatar-block">
              <img
                :src="!children.avatar ? avatar : createAvatarURL(children.avatar)"
                width="50px"
                height="50px"
                class="avatar-img"
              />
