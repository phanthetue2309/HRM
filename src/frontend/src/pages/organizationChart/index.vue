<template>
  <div class="org-outer-box" ref="org-outer-box"
  id="org-outer-box"
    v-dragscroll
    @touchmove.prevent
    @scroll.prevent
  ...
  >
    ...
    >
      ...
      <div class="path-container" ref="svg-line-outer-box">
          <SvgPath :rootGroupData="rootGroup"
...
export default {
  ...
  methods: {
    ...
    scrollViewToCenter() {
      const rootGroupBlockRef = this.$refs.content.$refs[`content-block-${this.rootGroup.type}-${this.rootGroup.id}`];
      rootGroupBlockRef.scrollIntoView({behavior: "smooth", inline: "center"});
