    ...
    <div class="general-infor">
      <el-card class="box-card mb-4 card-detail">
        <div slot="header" class="clearfix">
          ...
          <el-button
            ...
            v-else-if="dataInfo !== null && checkOwnerOrHasScope('user:edit_private_user_information_list')"
          >
            <img
        ...
        <div v-if="dataInfo" class="text item mx-2">
          <div class="row mb-1">
            ...
            <div class="col-7 col-xl-10 text-dark my-2">
              ...
              <div class="error" v-if="!$v.dataInfo.permanent_address.required">Field is required</div>
            </div>
          </div>
          ...
          <div class="row mb-1">
            ...
            <div class="col-7 col-xl-10 text-dark my-2">
              ...
              <div class="error" v-if="!$v.dataInfo.household_registration_number.minLength">
                Required at least {{ $v.dataInfo.household_registration_number.$params.minLength.min }} characters.
              </div>
            </div>
          </div>
          ...
          <div class="row mb-1">
            ...
            <div class="col-7 col-xl-10 text-dark my-2">
              ...
              <div class="error" v-if="!$v.dataInfo.contact_emergency.minLength">
                Required at least {{ $v.dataInfo.contact_emergency.$params.minLength.min }} digits.
              </div>
            </div>
          </div>
        </div>
        ...
        <div v-else>
          <div class="d-flex flex-row" @click="addData()" v-if="checkOwnerOrHasScope('user:edit_private_user_information_list')">
            <img
              class="img-add"
              style="height: 30px"
              :src="require('@/static/images/IconAdd.svg')"
            />
            <h3 class="mt-1 ml-3 text-info">
      ...
      <el-dialog title="Confirm" :visible.sync="isConfirming" width="30%">
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="saveData" :disabled="$v.dataInfo.$invalid">Save</el-button>
        </span>
      </el-dialog>
    </div>
  </div>
