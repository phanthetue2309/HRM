        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
                  <div class="mobile-screen d-flex align-items-center justify-content-center">
                    <el-rate
                        :disabled="!isEditing"
        ...
        <el-dialog :visible.sync="dialogDelete" title="Confirm Delete">
          <slot>
            ...
            <div class="text-center">
              <el-button type="danger" class="mt-3" @click="deleteTargetSkill()">
                Delete
              </el-button>
            </div>
          </slot>
        ...
        if (res.status === 201 || res.status === 200) {
          ...
          if (this.targetSkill.length !== 0) {
            ...
            this.targetSkill.map(e => {
              this.skillDefinitions.forEach(skill => skill.level.forEach(item => {
