      ...
      <div class="select-object-type-container">
        ...
        <div class="object-types-container">
          ...
          >
            ...
            <div class="btn add-object-type-action" @click="addObject(objectType)">
              Add
            </div>
          </div>
        </div>
    ...
    <div class="map-container">
      ...
      >
        ...
        <Object
          ...
          :objectType="
            allObjectTypes.find((objectType) => objectType.id === object.object_type)
          "
        />
      </svg>
    </div>
  ...
  methods: {
    ...
    async deleteObject(objectId) {
      ...
      if (res && res.status === 204) {
        const deletedObject = this.allObjects.find(object => object.id === objectId);
