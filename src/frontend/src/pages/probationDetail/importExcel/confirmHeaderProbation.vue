...
export default {
  ...
  methods: {
    ...
    getIndexOption(row, index) {
      if (!this.competenceValue && this.checkHeader(row, "Competencies")) this.competenceValue = index
      else if (!this.overallValue && this.checkHeader(row, "Overall")) this.overallValue = index
      else if (!this.outcomeValue && this.checkHeader(row, "Outcome")) this.outcomeValue = index
    },
