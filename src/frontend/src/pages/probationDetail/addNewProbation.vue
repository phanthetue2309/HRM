<template>
  <div>
    <div class="row m-4">
      <div class="col-12 col-lg-6 col-xl-6 ml-auto justify-xl-end d-flex justify-content-end">
        <el-button type="primary" @click="exportNewProbation">
          <font-awesome-icon :icon="['fas', 'file-export']" />
          <span class="ml-2">Export</span>
        </el-button>
        <el-button type="default" @click="$router.push({ path: `/evaluations/import` })">
    ...
    <el-card>
        ...
        <div class="col-9 col-lg-9 col-xl-9 mt-2">
          ...
          >
            ...
            <el-form-item label="Job title">
              <el-input :value="newProbation.jobTitleNames" placeholder="Job Title" disabled></el-input>
            </el-form-item>
            ...
            <el-form-item label="Choose Template" prop="evaluationTemplate">
              <el-select
                ...
                style="width: 70%"
              >
                <div v-for="templateType in listTemplateType" :key="templateType.id">
      ...
      >
        <el-table-column class="competence-header" fixed label="Competencies" width="450">
          <template slot-scope="scope">
            <span class="break-work">{{ scope.row.competence }}</span>
          </template>
        </el-table-column>
        <div v-for="(col,index) in competenceAssessorRoles" :key="index" class="d-none">
                ...
                <template slot-scope="scope">
                  <div v-if="((scope.row.assessor_roles)[col])">
                    <el-radio-group
                      ...
                      :disabled="checkIsAdmin ? !isEdit : !(((scope.row.assessor_roles)[col]).assessor===userId)"
                    >
      ...
      >
        <el-table-column prop="overCmt" label="Overall comments" width="450" fixed>
          <template slot-scope="scope">
            <span style="word-break: break-word;">{{ scope.row.overall_comment.term }}</span>
          </template>
        </el-table-column>
        <el-table-column label="Score" align="center" width="250">
          <template slot-scope="scope">
            <el-radio-group
              ...
              :disabled="checkIsAdmin ? !isEdit : !(scope.row.assessor===userId)"
            >
              <el-radio class="custom-radio" :label="1"></el-radio>
              <el-radio class="custom-radio" :label="2"></el-radio>
              <el-radio class="custom-radio" :label="3"></el-radio>
        ...
        <el-table-column label="Role" width="350" align="center">
          <template slot-scope="scope">
            <el-input placeholder="Please input" v-model="scope.row.overall_comment_role" disabled></el-input>
          </template>
        </el-table-column>
      </el-table>
      <br />
      ...
      <div class="outcome" v-show="showOutCome">
        ...
        <el-row :gutter="10">
          ...
          <el-col class="left-term-block">
            <el-row type="flex">
              <el-col :span="10">
                <el-radio v-model="newProbation.isCheckedTerm" :label="true">Definite Term</el-radio>
              </el-col>
              <el-col :span="15">
                <el-input
                  size="small"
          ...
          <el-col class="right-term-block">
            <el-radio v-model="newProbation.isCheckedTerm" :label="false">Indefinite term</el-radio>
          </el-col>
        </el-row>
        <el-row :gutter="10">
          <el-col :span="5" :offset="1">
        ...
        <el-row :gutter="10">
          ...
          <el-col class="radio-block">
            <el-radio v-model="newProbation.approved" :label="true">Approve</el-radio>
          </el-col>
          <el-col class="radio-block">
            <el-radio v-model="newProbation.approved" :label="false">Disapprove</el-radio>
          </el-col>
        </el-row>
      </div>
    </el-card>
