        ...
        <div class="col-12">
          <div class="border-title p-2">
            <div class="col-12 col-sm-5 col-md-3 col-xl-2">
              <div class="bg-logo">
                <img src="@/static/images/symbol.png" alt="Logo Company" class="logo-image">
              </div>
            </div>
            <div class="col-12 col-sm-7 col-md-9 col-xl-10 d-flex align-items-center">
              <h1>{{ data.name }}</h1>
            </div>
          </div>
        </div>
      ...
      <div class="text item">
        <div class="row">
          ...
          <div class="col-7 col-xl-10 text-dark my-2">
            ...
            <el-input
              v-else placeholder="Please input"
              size="small"
              v-model="data.name"
              required
            >
          ...
          <div class="col-7 col-xl-10 text-dark my-2">
            ...
            <el-select v-else v-model="data.manager" placeholder="Select Manager" size="mini" required>
              <el-option
  ...
  methods: {
    ...
    async saveData() {
      try {
        ...
        const responeData = await officeService.editAllFiledOffice(dataForm, this.$route.params.id)
        ...
        this.updatedConfirm = false
        let errorContent = error.response.status == 400 && error.response.data ? error.response.data : 'Updated Failed'
    ...
    async getData() {
      ...
      let responseData = await officeService.getDetailOffice(this.$route.params.id);
