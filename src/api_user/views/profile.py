...
class ProfileViewSet(BaseViewSet):
    ...
    required_alternate_scopes = {
        ...
        "get_auto_booking_lunch_profiles": [["user:view_public_user_information_list"]],
        "update_auto_booking": [["user:edit_public_user_information_list"]],
        "update_list_auto_booking": [["user_lunch:update_list_auto_booking"]],
        "get_profile_lunch": [["user:view_public_user_information_list"]],
        "update_veggie_user": [["user_lunch:update_list_auto_booking"]],
    }
    ...
    def get_auto_booking_lunch_profiles(self, request, *args, **kwargs):
        pfs_lunch_booking = Profile.objects.filter(auto_booking_lunch=True)
        pfs_lunch_not_booking = Profile.objects.filter(auto_booking_lunch=False)
        data = {
